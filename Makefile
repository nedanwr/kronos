...
WASM_SETTINGS = \
	...
	-s EXPORTED_FUNCTIONS='["_kronos_wasm_init","_kronos_wasm_run","_kronos_wasm_cleanup","_kronos_wasm_reset","_kronos_wasm_get_error","_kronos_wasm_version","_malloc","_free"]' \
