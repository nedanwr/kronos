---
title: Editor Setup
description: Set up your editor for Kronos development with syntax highlighting and LSP support
---
...
Restart your editor (VSCode/Cursor/Windsurf).

## Features

- Syntax highlighting
- Real-time error detection
- Keyword + symbol autocomplete
- Signature help
- Inlay hints
...
```vim
syn keyword kronosKeyword set let to as if for while function return print debug
...
contexts:
  main:
    ...
    - match: '\b(set|let|if|for|while|function|return|print|debug)\b'
...
The LSP server (`src/lsp/`) provides real-time diagnostics, completions, definitions/references, hover, signature help, inlay hints, call hierarchy, semantic tokens, and folding ranges.
