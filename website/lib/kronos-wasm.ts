...
export class KronosRuntime {
  ...
  private async _doInitialize(): Promise<void> {
    try {
      ...
      // The module is located at /wasm/kronos.js (in public folder)
      const createModule: CreateKronosModule = await import(
        /* webpackIgnore: true */ "/wasm/kronos.js"
      ).then((m) => m.default || m);
 ...
 */
export async function runKronos(source: string): Promise<KronosExecutionResult> {
