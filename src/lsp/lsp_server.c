...
static void handle_completion(const char *id) {
  const char *completions =
      ...
      "{\"label\":\"else if\",\"kind\":14,\"detail\":\"Else-if clause\"},"
      ...
      "{\"label\":\"by\",\"kind\":14,\"detail\":\"Step value for range loops\"},"
      ...
      "{\"label\":\"not\",\"kind\":14,\"detail\":\"Logical NOT operator\"},"
            ...
            "{\"label\":\"f\\\"\",\"kind\":14,\"detail\":\"F-string (formatted string literal)\"},"
            "{\"label\":\"len\",\"kind\":3,\"detail\":\"Get list or string length\"},"
            "{\"label\":\"uppercase\",\"kind\":3,\"detail\":\"Convert string to uppercase\"},"
            "{\"label\":\"lowercase\",\"kind\":3,\"detail\":\"Convert string to lowercase\"},"
            "{\"label\":\"trim\",\"kind\":3,\"detail\":\"Remove leading and trailing whitespace\"},"
            "{\"label\":\"split\",\"kind\":3,\"detail\":\"Split string by delimiter into list\"},"
            "{\"label\":\"join\",\"kind\":3,\"detail\":\"Join list of strings with delimiter\"},"
            "{\"label\":\"to_string\",\"kind\":3,\"detail\":\"Convert value to string\"},"
            "{\"label\":\"contains\",\"kind\":3,\"detail\":\"Check if string contains substring\"},"
            "{\"label\":\"starts_with\",\"kind\":3,\"detail\":\"Check if string starts with prefix\"},"
            "{\"label\":\"ends_with\",\"kind\":3,\"detail\":\"Check if string ends with suffix\"},"
            "{\"label\":\"replace\",\"kind\":3,\"detail\":\"Replace occurrences of substring in string\"},"
            "{\"label\":\"sqrt\",\"kind\":3,\"detail\":\"Square root of a number\"},"
            "{\"label\":\"power\",\"kind\":3,\"detail\":\"Raise base to exponent\"},"
            "{\"label\":\"abs\",\"kind\":3,\"detail\":\"Absolute value of a number\"},"
            "{\"label\":\"round\",\"kind\":3,\"detail\":\"Round number to nearest integer\"},"
            "{\"label\":\"floor\",\"kind\":3,\"detail\":\"Floor of a number\"},"
            "{\"label\":\"ceil\",\"kind\":3,\"detail\":\"Ceiling of a number\"},"
            "{\"label\":\"rand\",\"kind\":3,\"detail\":\"Random number between 0 and 1\"},"
            "{\"label\":\"min\",\"kind\":3,\"detail\":\"Minimum of numbers\"},"
            "{\"label\":\"max\",\"kind\":3,\"detail\":\"Maximum of numbers\"},"
            "{\"label\":\"to_number\",\"kind\":3,\"detail\":\"Convert string to number\"},"
            "{\"label\":\"to_bool\",\"kind\":3,\"detail\":\"Convert value to boolean\"},"
            "{\"label\":\"reverse\",\"kind\":3,\"detail\":\"Reverse a list\"},"
            "{\"label\":\"sort\",\"kind\":3,\"detail\":\"Sort a list\"},"
